// d:\Trading07\scripts\generate_verified_screenshots_v7.js
...
(async () => {
  console.log('===========================================================');
  console.log('   REAL QUANTUM TERMINAL BUYER SCREENSHOT GENERATION ENGINE V7');
  console.log('===========================================================');
  ...
  async function createAuthenticatedPage(width = 1920, height = 1080, isMobile = false) {
    ...
    // Dismiss initial BuyerDemoDashboardModal if open
